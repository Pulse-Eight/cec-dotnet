...
namespace LibCECTray.settings
{
  ...
  class CECSettingLogicalAddress : CECSettingNumeric
  {
    ...
    {
      LowerLimit = (int) CecLogicalAddress.Unknown;
    ...
    {
      if (int.TryParse((string)listControlConvertEventArgs.Value, out int iValue))
    ...
    {
      get {
        return (base.Value >= (int)CecLogicalAddress.Tv) && (base.Value <= (int)CecLogicalAddress.Broadcast) ?
          (CecLogicalAddress)base.Value :
          CecLogicalAddress.Unknown; }
      set {
        if (base.Value != (int)value)
    ...
    public static string FormatValue(int value)
    {
      ...
      {
        case CecLogicalAddress.Unknown:
    ...
    {
      var addr = (CecLogicalAddress)value;
      return (addr == CecLogicalAddress.Unknown) ||
        AllowedAddressMask.IsSet((CecLogicalAddress)value);
    }
